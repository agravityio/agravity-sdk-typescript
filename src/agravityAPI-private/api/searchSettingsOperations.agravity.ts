...
export class SearchSettingsOperationsService {
	...
	public httpSearchSettingsGet(
		...
		return this.httpClient.request<SearchSettings>('get', `${this.configuration.basePath}${localVarPath}`, {
	...
	public httpSearchSettingsPut(
		...
		let localVarPath = `/searchsettings`;
		return this.httpClient.request<SearchSettings>('put', `${this.configuration.basePath}${localVarPath}`, {
			context: localVarHttpContext,
			body: searchSettings,
			responseType: <any>responseType_,
			withCredentials: this.configuration.withCredentials,
