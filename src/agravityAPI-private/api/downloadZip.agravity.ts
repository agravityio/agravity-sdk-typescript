...
export class DownloadZipService {
    ...
    public httpDownloadZip(downloadZipRequest: DownloadZipRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<DownloadObject>>;
    public httpDownloadZip(downloadZipRequest: DownloadZipRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<DownloadObject>>;
    public httpDownloadZip(downloadZipRequest: DownloadZipRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<DownloadObject>(`${this.configuration.basePath}/downloadzip`,
            downloadZipRequest,
            {
