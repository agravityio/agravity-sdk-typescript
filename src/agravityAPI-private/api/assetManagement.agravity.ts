...
export class AssetManagementService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public httpAssetsGetById(id: string, fields?: string, expose?: boolean, items?: boolean, translations?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Asset>;
    public httpAssetsGetById(id: string, fields?: string, expose?: boolean, items?: boolean, translations?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Asset>>;
    public httpAssetsGetById(id: string, fields?: string, expose?: boolean, items?: boolean, translations?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Asset>>;
    public httpAssetsGetById(id: string, fields?: string, expose?: boolean, items?: boolean, translations?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (id === null || id === undefined) {
