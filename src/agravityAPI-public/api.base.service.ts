...
export class BaseService {
	...
	public configuration: AgravityPublicConfiguration;
	public encoder: HttpParameterCodec;

	constructor(basePath?: string | string[], configuration?: AgravityPublicConfiguration) {
		this.configuration = configuration || new AgravityPublicConfiguration();
