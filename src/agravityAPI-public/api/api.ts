...
export * from './publicCollectionSharing.pub.agravity';
import { PublicCollectionSharingService } from './publicCollectionSharing.pub.agravity';
...
export * from './signalRConnectionManagement.pub.agravity';
import { SignalRConnectionManagementService } from './signalRConnectionManagement.pub.agravity';
export const APIS = [PublicAssetManagementService, PublicAssetOperationsService, PublicAssetPublishingService, PublicAssetVersioningService, PublicAuthenticationManagementService, PublicCollectionManagementService, PublicCollectionSecureUploadService, PublicCollectionSharingService, PublicCollectionTypeManagementService, PublicConfigurationManagementService, PublicDownloadFormatManagementService, PublicGeneralManagementService, PublicHelperToolsService, PublicPublishingService, PublicSavedSearchService, PublicSearchManagementService, PublicStaticDefinedListManagementService, PublicTranslationManagementService, PublicWebAppDataService, PublicWorkspaceManagementService, SignalRConnectionManagementService];
