...
## AgravityAPI <a name="11.0.2"/> [11.0.2](https://www.npmjs.com/package/@agravity/private/v/11.0.2) (2026-06-03)
...
## AgravityAPI <a name="10.3.5"/> [10.3.5](https://www.npmjs.com/package/@agravity/private/v/10.3.5 (2026-05-03)

- Just version upgrade to match backend

## AgravityAPI <a name="10.3.4"/> [10.3.4](https://www.npmjs.com/package/@agravity/private/v/10.3.4) (2026-04-13)
...
-   _[breaks_api]_ #1520 Refactor notification settings to use new db entity instead
-   #1545 Add endpoint and model to fetch user name and email from public endpoints
    -   Update private GET `/auth/users/{id}` description - This gets the user information about an Agravity User (incl. Online Status). Only full information if requester and userId are the same or it has role Admin.
...
-   Add support of target file name of HttpImageDynamicEdit endpoint (private+public)
...
## AgravityAPI <a name="10.1.6"/> [10.1.6](https://www.npmjs.com/package/@agravity/private/v/10.1.6) (2025-11-16)
